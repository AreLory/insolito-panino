...
if (!jwtSecret) {
  throw new Error("JWT is not defined. Add JWT env variable in Render dashboard.");
}
...
console.log("JWT Secret:", jwtSecret ? "defined ✅" : "undefined ❌");
console.log("Mongo URI:", mongoUri ? "defined ✅" : "undefined ❌");
